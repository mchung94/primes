(defpackage #:primesieve-cmd-tests
  (:use #:common-lisp #:fiveam #:primesieve-cmd))
(in-package #:primesieve-cmd-tests)

(def-suite primesieve-cmd :in primes/tests:primes)
(in-suite primesieve-cmd)

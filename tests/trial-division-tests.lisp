(defpackage #:trial-division-tests
  (:use #:common-lisp #:fiveam #:trial-division))
(in-package #:trial-division-tests)

(def-suite trial-division :in primes/tests:primes)
(in-suite trial-division)
